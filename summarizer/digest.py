...
- 本文で触れた中から特に重要なものを最大{MAX_HIGHLIGHTS}件、各1文で挙げてください。
- 重要なものが少なければ{MAX_HIGHLIGHTS}件に満たなくて構いません。該当が無ければ空の配列にしてください。
...
{groups_info.strip()}"""
    ...
    return CategoryDigest(
        ...
        highlights=_normalize_bullets(llm_result.highlights)[:MAX_HIGHLIGHTS],
